...
class Tokenizer:
    ...
    def tokenize(self) -> list:
        ...
        ans = self.program.replace('(', ' ( ').replace(')', ' ) ').split()
...
class Parser:
    ...
    def parseS(self):
        ...
        # Si el siguiente es otro '(' estamos frente 
        # a un bloque
...
# El programa es invalido porque la a-ridad de la función foo es distinta a cuando se
# definió y también porque los bloques no estan delimitados
# por paréntesis

ej_programa_invalido = '''
...
(if (not (can-move-p :north)) (move 1) (skip))
...
# El ejemplo a continuación define un programa valido con recursion, parametros, bloques, 
# aridad en las funciones y variables
